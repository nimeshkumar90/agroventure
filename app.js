...
let hours_req=0;
let land_size=1;
let data_sheet_wheat=[0.05, 0.25, 0.45, 0.65, 0.55];
...
let water_req_div=document.querySelector("#water_req_div");
...
function calc_water_need(){
          ...
          if (current_crop == "Wheat"){
              ...
              console.log("hours_req",hours_req);
                              water_req_div.innerHTML="<p>"+ hours_req +" Hours<p>";
              return hours_req;
                    }
                    else
                    {
                              water_req_div.innerHTML="No need to irrigate more right now";
